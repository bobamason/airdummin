...
public class LoadingAnimation {
	...
	private class Triangle {
		...
		private static final int C0ORDS_PER_VERTEX = 3;

		private final float[] triangleCoords = { -0.5f, 0.5f, 0.0f, // top
				0.5f, -0.5f, 0.0f, // bottom right
				0.5f, 0.5f, 0.0f // bottom left
		};

		private int vertexCount = triangleCoords.length / C0ORDS_PER_VERTEX;

		private int vertexStride = C0ORDS_PER_VERTEX * 4;
